...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIView *startView = self.startViewController.view;
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    self.playScreenViewController.accumulatedTime = self.playScreenViewController.accumulatedTime;
    [self.playScreenViewController.timer invalidate];
